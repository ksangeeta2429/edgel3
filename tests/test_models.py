...
def test_load_embedding_model_path():
    ...
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_53.5.h5'

    embedding_model_path = load_embedding_model_path('ft', 63.5)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_63.5.h5'

    embedding_model_path = load_embedding_model_path('ft', 72.3)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_72.3.h5'

    embedding_model_path = load_embedding_model_path('ft', 73.5)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_73.5.h5'

    embedding_model_path = load_embedding_model_path('ft', 81.0)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_81.0.h5'

    embedding_model_path = load_embedding_model_path('ft', 87.0)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_87.0.h5'

    embedding_model_path = load_embedding_model_path('ft', 90.5)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_90.5.h5'

    embedding_model_path = load_embedding_model_path('ft', 95.45)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_ft_audio_sparsity_95.45.h5'

    #Check the output paths for kd models
    embedding_model_path = load_embedding_model_path('kd', 53.5)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_53.5.h5'

    embedding_model_path = load_embedding_model_path('kd', 63.5)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_63.5.h5'

    embedding_model_path = load_embedding_model_path('kd', 72.3)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_72.3.h5'

    embedding_model_path = load_embedding_model_path('kd', 73.5)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_73.5.h5'

    embedding_model_path = load_embedding_model_path('kd', 81.0)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_81.0.h5'

    embedding_model_path = load_embedding_model_path('kd', 87.0)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_87.0.h5'

    embedding_model_path = load_embedding_model_path('kd', 90.5)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_90.5.h5'

    embedding_model_path = load_embedding_model_path('kd', 95.45)
    assert '/'.join(embedding_model_path.split('/')[-2:]) == 'audio_model/edgel3_kd_audio_sparsity_95.45.h5'
